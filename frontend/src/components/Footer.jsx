...
const Footer = () => {
  ...
  const footerCopyright = settings?.footerText || '© 2026 SyncSaaS System. All rights reserved.';
  const footerDesc = settings?.footerDescription || 'Transform your SaaS distribution with a unified platform that connects software owners, dedicated resellers, and client businesses in one consistent experience.';
